...
<main class="body">
    <div class="content">
        <div class="box-tab-buttons">
            ...
            <a href="/products/categories_four" class="view" button-tab>Subcategorías 3</a>
            <div class="clear"></div>
        </div>
        <div class="box-buttons">
            <a data-button-modal="deleteCategories"><i class="material-icons">delete</i><span>Eliminar</span></a>
            <a data-button-modal="categories" data-number="four"><i class="material-icons">add</i><span>Nuevo</span></a>
            <a href="/products"><i class="material-icons">arrow_back</i><span>Regresar</span></a>
            <div class="clear"></div>
        </div>
        <div class="table-responsive-vertical padding">
            <table id="tblCategories" class="display" data-page-length="100" data-table-order="1">
                <thead>
                    <tr>
                        <th width="20px"></th>
                        <th>Categoría</th>
