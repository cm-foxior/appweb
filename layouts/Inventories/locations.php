...
$this->dependencies->add(['js', '{$path.js}Inventories/locations.js?v=1.0']);
                    ...
                    <?php if (Permissions::user(['block_inventories_locations','unblock_inventories_locations']) == true) : ?>
                        <td class="button">
                            <?php if ($value['blocked'] == true) : ?>
                                <a data-action="unblock_inventory_location" data-id="<?php echo $value['id']; ?>"><i class="fas fa-lock"></i><span>{$lang.unblock}</span></a>
                            <?php elseif ($value['blocked'] == false) : ?>
                                <a data-action="block_inventory_location" data-id="<?php echo $value['id']; ?>"><i class="fas fa-unlock"></i><span>{$lang.block}</span></a>
                            <?php endif; ?>
                        </td>
                    <?php endif; ?>
