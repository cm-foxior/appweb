...
$this->dependencies->add(['css', '{$path.plugins}animate/animate.css']);
$this->dependencies->add(['css', '{$path.plugins}owl-carousel/css/owl.carousel.min.css']);
$this->dependencies->add(['js', '{$path.plugins}owl-carousel/js/owl.carousel.min.js']);
$this->dependencies->add(['js', '{$path.plugins}wow/wow.min.js']);
...
<div class="floating_contacts">
    <a href="" style="background-color: #E91E63;"><i class="fas fa-envelope"></i></a>
    <a href="" style="background-color: #3f51b5;"><i class="fas fa-phone"></i></a>
    <a href="" style="background-color: #0078FF;"><i class="fab fa-facebook-messenger"></i></a>
    <a href="" style="background-color: #4AC959;"><i class="fab fa-whatsapp"></i></a>
</div>
<nav class="navbar navbar-expand-lg navbar-light navbar-floating">
  <div class="container">
    <a class="navbar-brand" href="#">
      <img src="{$path.images}imagotype_color.svg" alt="" width="40">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      <ul class="navbar-nav ml-lg-5 mt-3 mt-lg-0">
        ...
        <li class="nav-item dropdown active">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Menu</a>
      ...
      <div class="ml-auto my-2 my-lg-0">
        <a href="/login" class="btn btn-dark rounded-pill">Iniciar sesión</a>
      </div>
    </div>
  </div>
</nav>
<div class="page-hero-section bg-image hero-home-1" style="background-image: url({$path.images}Index/bg_hero_1.svg);">
      ...
      <div class="row align-items-center h-100">
        ...
        <div class="col-lg-6 d-none d-lg-block wow zoomIn">
          <div class="img-place mobile-preview shadow floating-animate">
            <img src="{$path.images}Index/app_preview_1.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{$path.images}Index/clients/alter_sport.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{$path.images}Index/clients/cleaning_service.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{$path.images}Index/clients/creative_photo.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="{$path.images}Index/clients/global_tv.png" alt="">
        </div>
      </div>
    </div>
  </div>
</div>
<div class="position-realive bg-image" style="background-image: url({$path.images}Index/pattern_1.svg);">
<div class="page-section">
  <div class="container">
    <div class="row">
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="{$path.images}Index/app_preview_2.png" alt="">
        </div>
      </div>
...
<div class="page-section">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
          <img src="{$path.images}Index/app_preview_3.png" alt="">
        </div>
      </div>
    </div>
  </div>
...
<div class="page-section fg-white">
  <div class="container">
    ...
    <div class="row justify-content-center mt-5">
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/rocket.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="200ms">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/testimony.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="400ms">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/promotion.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="600ms">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/coins.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="800ms">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/support.svg" alt="">
          </div>
      ...
      <div class="col-md-6 col-lg-3 py-3">
        <div class="card card-body border-0 bg-transparent text-center wow zoomIn" data-wow-delay="1000ms">
          <div class="mb-3">
            <img src="{$path.images}Index/icons/laptop.svg" alt="">
          </div>
...
<div class="page-section bg-image" style="background-image: url({$path.images}Index/pattern_2.svg);">
  <div class="container">
...
<div class="page-section bg-image bg-image-overlay-dark" style="background-image: url({$path.images}Index/bg_testimonials.jpg);">
    ...
    <div class="row">
      <div class="col-lg-7 py-3 mb-5 mb-lg-0">
        <div class="img-place w-lg-75 wow zoomIn">
          <img src="{$path.images}Index/illustration_contact.svg" alt="">
        </div>
      </div>
      <div class="col-lg-5 py-3">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 py-2">
        <img src="{$path.images}imagotype_white.svg" alt="" width="40">
